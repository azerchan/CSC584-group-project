...
public class LoginServletA extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            LoginBeanA loginBean = new LoginBeanA();
            loginBean.setadminID(adminID);
            loginBean.setadminPassword(adminPassword);
            
            LoginDaoAdmin loginDaoA = new LoginDaoAdmin();
            
            String userValidate = loginDaoA.authenticateUser(loginBean);
