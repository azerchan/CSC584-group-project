    ...
    <body background="background.jpg">
        ...
        <section>
            ...
            <sql:setDataSource var="myDatasource" 
                               ...
                               url="jdbc:derby://localhost:1527/HONK" user="app" 
                               password="app"/>
            ...
            <c:if test="${(subject!=null)&&(feedType!=null)&&(dateVisit!=null)&&(timeHonk!=null)&&(feedback!=null)}" var="result">
            </c:if>
            ...
            <sql:param value="${timeHonk}"/>
            <sql:param value="${feedback}"/>
            ...
            </form><sql:query var="result" dataSource="myDatasource">
